...
function draw() {
  ...
  canvas0.noStroke();
  canvas0.fill(0);
  canvas0.ellipse (470, 450, 50);
  canvas0.quad (400-20, 450-20, 400+30, 450-30, 400+15, 450+15, 400-25, 450+25);
  canvas0.square (320-30, 425, 50);
  canvas0.triangle (220-40, 470, 220, 470-50, 220+40, 470);
  ...
  if (sel_ellipse==1) {
    ...
    canvas0.quad (r_Wrist.x+10-d, r_Wrist.y+10-d, r_Wrist.x+d, r_Wrist.y-d, r_Wrist.x-10+d, r_Wrist.y-10+d, r_Wrist.x+5-d, r_Wrist.y-5+d);
  } else if (sel_square==1) {

    canvas0.square (r_Wrist.x, r_Wrist.y, d);
  } else if (sel_triangle==1) {

    canvas0.triangle(r_Wrist.x-5-d, r_Wrist.y+5+d, r_Wrist.x, r_Wrist.y-d, r_Wrist.x+5+d, r_Wrist.y+5+d);
  }
